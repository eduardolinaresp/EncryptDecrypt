 ...
 */
package com.edward.encryptdecrypt;
...
public class EncryptDecrypt {
    ...
    final public String decryptedUserPassword;
     ...
     *
     *
     * @param pPropertyFileName /Name of the properties file that contains the
     * password
     * @param pUserPasswordKey /Left hand side of the password property as key.
     * @param pIsPasswordEncryptedKey /Key in the properties file that will tell
     * us if the password is already encrypted or not
     *
     * @throws Exception
     */
